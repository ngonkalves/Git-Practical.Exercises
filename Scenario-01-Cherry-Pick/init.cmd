...
REM ## master ##
call:gitCreateBranch %CLIENT1% master
...
call:gitCommitAndPush %CLIENT1% featureA "C3" C3.txt "C3"

REM ## master ##
call:gitCommitAndPush %CLIENT1% master "C4" C4.txt "C4"
call:gitCommitAndPush %CLIENT1% master "C5" C5.txt "C5"

REM ## featureB ##
call:gitCreateBranch %CLIENT1% featureB
call:gitResetBackBranch %CLIENT1% featureB 1
call:gitCommitAndPush %CLIENT1% featureB "C6" C6.txt "C6"
call:gitCommitAndPush %CLIENT1% featureB "C7" C7.txt "C7"
