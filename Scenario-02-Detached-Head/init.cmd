...
call ../operations.cmd gitCommitAndPush %CLIENT1% master "C3" C3.txt "C3"
call ../operations.cmd gitCommitAndPush %CLIENT1% master "C4" C4.txt "C4"
call ../operations.cmd showStartRepoInfo %CLIENT1%
REM ## featureA ##
call ../operations.cmd gitCreateBranch %CLIENT1% featureA
call ../operations.cmd gitResetBack %CLIENT1% 1
call ../operations.cmd showStartRepoInfo %CLIENT1%
REM ## master ##
call ../operations.cmd gitSwitchBranch %CLIENT1% master REM switch to master
REM ================================== CLIENT 1 ==================================
