...
REM ================================== CLIENT 2 ==================================
call:gitClone %CLIENT2% %CLIENT_USER2%
REM ================================== CLIENT 2 ==================================

REM ================================== CLIENT 3 ==================================
call:gitClone %CLIENT3% %CLIENT_USER3%
REM ================================== CLIENT 3 ==================================

REM ================================== CLIENT 1 ==================================
REM ## master ##
call:gitCommitAndPush %CLIENT1% master "C1" C1.txt "C1"
call:gitCreateTag %CLIENT1% initial-commit
...
REM ================================== CLIENT 2 ==================================
REM ## master ##
call:gitPull %CLIENT2%
REM ================================== CLIENT 2 ==================================


REM ================================== CLIENT 3 ==================================
REM ## master ##
call:gitPull %CLIENT3%
REM ================================== CLIENT 3 ==================================
...
REM ## feature1 ##
call:gitCreateBranch %CLIENT1% feature1
call:gitResetBack %CLIENT1% 2
call:gitCommitAndPush %CLIENT1% feature1 "C4" feature1.txt "first line"
call:gitCommitAndPush %CLIENT1% feature1 "C5" feature1.txt "second line"
call:showStartRepoInfo %CLIENT1%

REM ## feature2 ##
call:gitCreateBranch %CLIENT1% feature2
call:gitResetToTag %CLIENT1% initial-commit
call:gitCommitAndPush %CLIENT1% feature2 "C6" feature2.txt "C6 first line"
call:gitCommitAndPush %CLIENT1% feature2 "C7" feature2.txt "C7 seconf line"
::call:showStartRepoInfo %CLIENT1%
REM ================================== CLIENT 1 ==================================

REM ================================== CLIENT 3 ==================================
REM ## master ##
call:gitCommit %CLIENT3% master "C8" C8.txt "C8"
call:gitCommit %CLIENT3% master "C9" C9.txt "C9"
call:showStartRepoInfo %CLIENT3%
REM ================================== CLIENT 3 ==================================
