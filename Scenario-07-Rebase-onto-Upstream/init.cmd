...
call ../operations.cmd gitCommit %CLIENT1% featureA "C4" C4.txt "C4"

REM ================================== CLIENT 2 ==================================
REM ## master ##
call ../operations.cmd gitPull %CLIENT2%
call ../operations.cmd gitCommitAndPush %CLIENT2% featureA "C5" C5.txt "C5"
call ../operations.cmd gitCommitAndPush %CLIENT2% featureA "C6" C6.txt "C6"
REM ================================== CLIENT 2 ==================================

REM ## master ##
call ../operations.cmd gitPull %CLIENT1%
