...
call:gitCommitAndPush %CLIENT1% featureA "C1" C1.txt "C1"
call:gitCommitAndPush %CLIENT1% featureA "C2" C2.txt "C2"

REM ## featureA ##
call:gitSwitchBranch %CLIENT1% featureA
call:gitCommit %CLIENT1% featureA "C3" C3.txt "C3"
call:gitCommit %CLIENT1% featureA "C4" C4.txt "C4"

REM ================================== CLIENT 2 ==================================
REM ## master ##
call:gitPull %CLIENT2%
call:gitCommitAndPush %CLIENT2% featureA "C5" C3.txt "C5"
call:gitCommitAndPush %CLIENT2% featureA "C6" C6.txt "C6"
REM ================================== CLIENT 2 ==================================

REM ## master ##
call:gitPull %CLIENT1%
